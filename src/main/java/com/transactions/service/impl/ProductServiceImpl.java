...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public ResponseEntity<ApiResponse<ProductResponse>> updateProductById(UUID id, ProductRequest request) {
        Optional<Product> product = productRepo.findById(id);
        if (product.isEmpty()) {
            return new ResponseEntity<>(
                    new ApiResponse<>(
    ...
    public ResponseEntity<ApiResponse<List<TaxResponse>>> getAllTax() {
        ...
        List<TaxResponse> responseList = taxes.stream()
    ...
    private ProductResponse toProductResponse(Product product) {
        return ProductResponse.builder()
                ...
                .taxes(product.getTaxes().stream().map(t -> TaxResponse.builder()
                        .id(t.getId())
                        .name(t.getName())
