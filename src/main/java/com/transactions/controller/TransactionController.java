...
public class TransactionController {
  ...
  public ResponseEntity<ApiResponse<TransactionResponse>> create(
      @RequestBody TransactionRequest request, @AuthenticationPrincipal UserPrincipal currentUser) {
  ...
  public ResponseEntity<ApiResponse<TransactionResponse>> deleteTransaction(@PathVariable UUID id) {
